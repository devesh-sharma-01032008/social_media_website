...
export default function AddPost() {
  ...
  return (
    <main className="flex">
      <form action="login.php" method="post" className="container m-auto px-3 py-3 col-equal-2 mx-2 add-post-form" onSubmit={CreatePost}>
        ...
        <input type="text" className="input-field" name="post-desc" id="post-desc" placeholder="Enter post-desc here" required />
